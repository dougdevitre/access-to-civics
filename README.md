...
Five states are ingested, eighteen clauses in all. Missouri is the pilot, with twelve clauses from
the official Revisor pages. The other four are there for what they answer differently: Texas, whose
site serves an application shell to every document URL; Nebraska, the only single-chamber
legislature in the country; Delaware, the only state that amends its constitution without ever
asking the voters; and Florida, whose amendments need sixty percent at the ballot. All carry sha256
provenance and human-reviewed glosses at two reading levels. Every other state appears as a verified
